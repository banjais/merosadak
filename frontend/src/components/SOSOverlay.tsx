...
export const SOSOverlay: React.FC<SOSOverlayProps> = ({ isOpen, onClose, userLocation }) => {
  ...
  return (
    <div className="fixed inset-0 z-[5000] flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-red-950/80 backdrop-blur-xl animate-in fade-in duration-500" onClick={onClose} />
      
      <div className="relative w-full max-w-md glass-pilot border-2 border-red-500/30 rounded-[40px] shadow-[0_0_100px_rgba(239,68,68,0.4)] overflow-hidden animate-in zoom-in-95 duration-300">
