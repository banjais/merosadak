...
export const MapControls: React.FC<MapControlsProps> = ({ userLocation }) => {
  ...
  return (
    <div className="absolute bottom-36 right-4 z-[1000] flex flex-col gap-2">
      <div className="flex flex-col bg-white/70 backdrop-blur-xl border border-white/40 rounded-[1.5rem] overflow-hidden shadow-[0_8px_24px_rgba(27,51,85,0.1)]">
        <button 
      ...
      <button 
        ...
        className="p-3 bg-white/70 backdrop-blur-xl border border-white/40 text-primary rounded-[1.5rem] shadow-[0_8px_24px_rgba(27,51,85,0.1)] hover:text-white hover:bg-gradient-to-br hover:from-primary hover:to-tertiary transition-all active:rotate-180 duration-500"
