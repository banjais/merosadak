...
const HIGHWAY_CODE_ALIASES: Record<string, string[]> = {
  NH01: ['NH01', 'H01', 'MAHENDRA', 'EAST-WEST', 'EAST WEST'],
  NH17: ['NH17', 'H04', 'PRITHVI'],
  NH44: ['NH44', 'H05', 'NARAYANGHAT-MUGLING', 'MUGLING-NARAYANGHAT', 'NARAYANGARH-MUGLING'],
  NH13: ['NH13', 'H13', 'BP', 'B.P.', 'SINDHULI'],
  NH48: ['NH48', 'H10', 'SIDDHARTHA'],
  NH41: ['NH41', 'H02', 'TRIBHUVAN', 'BYROAD', 'BY-ROAD'],
  NH42: ['NH42', 'H02', 'TRIBHUVAN', 'BYROAD'],
  NH64: ['NH64', 'H06', 'KARNALI'],
  NH03: ['NH03', 'H03', 'ARANIKO'],
  NH15: ['NH15', 'H15', 'MID-HILL', 'PUSHPALAL', 'MADHYAPAHADI'],
  NH02: ['NH02', 'H07', 'POSTAL', 'HULAKI'],
  NH09: ['NH09', 'MADAN BHANDARI'],
  NH08: ['NH08', 'H08', 'KOSHI'],
  NH07: ['NH07', 'H09', 'MECHI'],
  NH16: ['NH16', 'H12', 'SAGARMATHA'],
  NH66: ['NH66', 'H14', 'MAHAKALI'],
  H01: ['NH01', 'MAHENDRA'],
  H04: ['NH17', 'PRITHVI'],
