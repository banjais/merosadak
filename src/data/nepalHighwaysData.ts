...
export const CITIES_AND_JUNCTIONS: CityNode[] = [
  ...
  { id: 'btm', name: 'Birtamod', nepaliName: 'विर्तामोड', district: 'Jhapa', province: 'Koshi', lat: 26.4833, lng: 88.0833, elevationM: 100, isMajorHub: false, connectedHighways: ['NH01'] },
  { id: 'bhp', name: 'Bhadrapur', nepaliName: 'भद्रपुर', district: 'Jhapa', province: 'Koshi', lat: 26.5333, lng: 88.0833, elevationM: 101, isMajorHub: false, connectedHighways: ['NH01'] },
