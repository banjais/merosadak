...
export const NEPAL_DIALECTS: DialectInfo[] = [
  {
    ...
    primaryHighways: ['NH01 Mahendra', 'NH04 Prithvi', 'NH02 Tribhuvan', 'NH13 BP Highway', 'NH17 Mid-Hill'],
  ...
  },
  {
    ...
    primaryHighways: ['NH01 Far-West', 'NH14 Mahakali', 'NH06 Karnali Highway', 'Seti Corridor'],
  ...
  },
  {
    ...
    primaryHighways: ['NH01 East Mahendra', 'NH16 Postal Highway', 'Janakpur Bypass'],
  ...
  },
  {
    ...
    primaryHighways: ['NH02 Tribhuvan Bypass', 'NH01 Narayangadh-Butwal', 'Birgunj Corridor'],
  ...
  },
  {
    ...
    primaryHighways: ['NH01 Mahendra Highway Terai stretches', 'Postal Highway Terai'],
  ...
  },
  {
    ...
    primaryHighways: ['NH03 Arniko', 'NH13 BP Highway Hills', 'Galchhi-Trishuli', 'Pasang Lhamu Highway'],
  ...
  },
  {
    ...
    primaryHighways: ['Kathmandu Ring Road', 'NH03 Arniko Banepa', 'Bandipur Highway Access', 'Tansen Bazar'],
  ...
  },
  {
    ...
    provinces: ['Gandaki'],
    primaryHighways: ['NH04 Pokhara Valley', 'NH15 Mid-Hill Highway Pokhara-Baglung', 'Besisahar-Manang Corridor'],
  ...
  },
  {
    ...
    provinces: ['Koshi'],
    primaryHighways: ['NH09 Mechi Highway', 'NH08 Koshi Highway (Dharan-Dhankuta)', 'Tamor Corridor'],
